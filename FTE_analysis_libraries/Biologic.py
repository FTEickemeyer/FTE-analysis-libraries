...
def load_Biologic_CV(dir, FN, cell_area, light_int = 100, J_1sun = None, raw_data = False, both_scans = False, reverse_scan = True, warning = True):
    """
...
def load_Biologic_CV(dir, FN, cell_area, encoding = "ISO-8859-1", light_int = 100, J_1sun = None, raw_data = False, both_scans = False, reverse_scan = True, warning = True):
    """
    Loads CV data measured with a Biologic potentiostat. It works if the CV was measured first forward and then backward.
...
if __name__ == "__main__":
    ...
    multiple_Nyquist_and_Bode_plot(fs_list, Zs_list, label_list = data_label, f_range = f_range, figsize = 15, textsize = 12, what_to_show = ['nyquist', 'bode'])